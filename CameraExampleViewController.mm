...
BoundingBoxView *boundingBoxView = nil;
        ...
        if (!run_status.ok()) {
            ...
            for (int index = 0; index < predictions.size(); index += 1) {
                ...
                if (predictionValue > 0.05f) {
                    ...
                    // add new BoundingBox to mutable array
                    [boundingboxes addObject:[[BoundingBox alloc] init:CGRectMake(100, (int)(predictionValue * 500), 200, 100) className:labelObject]];
                }
            }
            // update BoundingBox array in BoundingBoxView
            [boundingBoxView setBoundingboxes: [boundingboxes copy]];

            dispatch_async(dispatch_get_main_queue(), ^(void) {
                // force redraw BoundingBoxView
...
- (void)viewDidLoad {
    ...
    // create and add bounding box view
    boundingBoxView = [[BoundingBoxView alloc] initWithFrame:previewView.frame];
    [previewView addSubview: boundingBoxView];
}
